          ...
          <div className='bg-white rounded-[20px] border border-[#1B7700]/30 relative min-h-[480px] lg:min-h-[520px] overflow-hidden'>
            ...
            <div className='absolute right-4 lg:right-6 top-[80px] lg:top-[90px]'>
              <div className='relative w-[40px] h-[40px]'>
                {/* Top dot - with blur */}
                <div className='absolute top-0 left-1/2 -translate-x-1/2 w-[10px] h-[10px] bg-[#1C1C1C] rounded-full' style={{ filter: 'blur(2px)' }}></div>
                {/* Bottom-left dot - with blur */}
                <div className='absolute bottom-0 left-0 w-[8px] h-[8px] bg-[#1C1C1C] rounded-full' style={{ filter: 'blur(2px)' }}></div>
                {/* Bottom-right dot - with blur */}
                <div className='absolute bottom-1 right-0 w-[6px] h-[6px] bg-[#1C1C1C] rounded-full' style={{ filter: 'blur(2px)' }}></div>
              </div>
            </div>
